  ...
  ST.diagnose = function () {
    ...
    if (site) {
      out.found = {
        ...
        guard: ST.guard && ST.guard.last ? Object.assign(ST.guard.last(), { sendKey: (ST.site && ST.site.sendKey) || 'enter', sendGuard: !!(ST.site && ST.site.sendGuard !== false), agoSec: ST.guard.last().at ? Math.round((Date.now() - ST.guard.last().at) / 1000) : null }) : null,
